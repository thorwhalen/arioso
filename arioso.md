...
#### *property* audio_array *: [Any](https://docs.python.org/3/library/typing.html#typing.Any) | [None](https://docs.python.org/3/builtins/constants.html#None)*

Shortcut to audio.audio_array.

#### *property* audio_bytes *: [bytes](https://docs.python.org/3/builtins/stdtypes.html#bytes) | [None](https://docs.python.org/3/builtins/constants.html#None)*

Shortcut to audio.audio_bytes.

#### *property* audio_url *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*

Shortcut to audio.audio_url.

#### *property* error_message *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*

Extract error message from metadata, if any.

#### *property* is_error *: [bool](https://docs.python.org/3/builtins/functions.html#bool)*
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Song`](_autosummary/arioso.base.html.md#arioso.base.Song)]
* **Returns:**
...
| [`ALWAYS_RAISE_UNSUPPORTED`](_autosummary/arioso.translation.html.md#arioso.translation.ALWAYS_RAISE_UNSUPPORTED)   | Affordances that always raise on an unsupported platform, regardless of that platform's own `on_unsupported_param` policy.   |
|-----------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
...
inside [`make_kwargs_trans()`](_autosummary/arioso.translation.html.md#arioso.translation.make_kwargs_trans) – reached solely by the REST-fallback
`generate` built by [`make_generate_func()`](_autosummary/arioso.translation.html.md#arioso.translation.make_generate_func). Every platform that ships
